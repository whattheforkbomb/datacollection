...
data class ESenseEvent (
    ...
    companion object {
        val HEADER = "TIME_STAMP,RAW_ACCELERATION_X,RAW_ACCELERATION_Y,RAW_ACCELERATION_Z,RAW_GYROSCOPE_X,RAW_GYROSCOPE_Y,RAW_GYROSCOPE_Z,ACCELERATION_X,ACCELERATION_Y,ACCELERATION_Z,GYROSCOPE_X,GYROSCOPE_Y,GYROSCOPE_Z"
    }
}
